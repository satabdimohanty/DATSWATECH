...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "DATSWATECH transformed our data infrastructure completely. Their analytics solution helped us identify growth opportunities we never knew existed.",
      name: "Rajesh Kumar",
      company: "CTO, FinServe Technologies",
      image: "/professional-indian-businessman-portrait-corporate.jpg",
    },
    {
      quote:
        "The ERP system they implemented streamlined our entire operations. We've reduced processing time by 60% and improved accuracy significantly.",
      name: "Priya Sharma",
      company: "Operations Director, ManufactureX",
      image: "/professional-indian-businesswoman-portrait-corpora.jpg",
    },
    {
      quote:
        "Their AI automation solutions are cutting-edge. The chatbot and process automation they built handles 80% of our customer queries automatically.",
      name: "Amit Patel",
      company: "CEO, RetailHub India",
      image: "/professional-indian-entrepreneur-portrait-modern-h.jpg",
    },
  ]
